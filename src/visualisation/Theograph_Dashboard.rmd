...
fluidRow(
  column(
    width = 4,
    h3("Diagnoses"),
    p(tags$em("Date included is of initial diagnosis."), style = "margin-top:-10px; margin-bottom:6px; color:#666; font-size:11pt;"),
    hr(),
  ...
  column(
    width = 4,
    h3("Biomedical tests"),
    p(tags$em("Date included is of latest test."), style = "margin-top:-10px; margin-bottom:6px; color:#666; font-size:11pt;"),
    hr(),
  ...
  column(
    width = 4,
    h3("Prescriptions"),
    p(tags$em("Date included is of initial prescription."), style = "margin-top:-10px; margin-bottom:6px; color:#666; font-size:11pt;"),
    hr(),
